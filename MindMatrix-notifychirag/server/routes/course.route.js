...
const {getComments, getCoursesByIds,uploadCourse, editCourse, getSingleCourse, getAllCourses, getCourseByUser, addComment, addReply, addReview, getAdminAllCourses, deleteCourse, addReplyToReview, uploadVideo } = require("../controllers/course.controller");
