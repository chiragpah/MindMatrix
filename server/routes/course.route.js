...
const { getComments, uploadCourse, editCourse, getSingleCourse, getAllCourses, getCourseByUser, addComment, addReply, addReview, getAdminAllCourses, addReplyToReview, deleteCourse, uploadVideo } = require("../controllers/course.controller");
